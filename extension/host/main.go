...
var envArgRe = regexp.MustCompile(`^(RIG_HTTP_PORT|RIG_GRAFANA_PORT|RIG_STEPCA_PORT|RIG_BACKSTAGE_PORT|RIG_REDUNDANCY|RIG_OBS|RIG_BACKSTAGE|RIG_JUICE|TENANT)=[A-Za-z0-9._-]*$`)
